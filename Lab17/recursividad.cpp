...
/**
 * Devuelve true si la secuencia de letras entre los índices
 * i y j del string S es un palíndromo, false en caso
 * contrario.
 */
...
/**
 * Invierte el contenido del arreglo de enteros A entre los
 * índices i y j.
 */
...
/**
 * Toma un string S de longitud n y produzca su inverso a
 * partir del índice i.
 */
...
/**
 * Encuentra y devuelve el elemento máximo en el arreglo A
...
/**
 * Convierte un string S de dígitos, a partir del dígito en
 * la posición i, en el entero que representa.
 */
